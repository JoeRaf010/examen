...
public class Client extends Model{
    ...
    public Client findWhere(String id) throws Exception{
     Connection conn=null;
        PreparedStatement pst=null;
        ResultSet result = null;
        ...
        try{
            conn  = hlp.getSQLServerConnection();
            pst=conn.prepareStatement("SELECT * FROM Client WHERE id=?",result.TYPE_SCROLL_INSENSITIVE,result.CONCUR_READ_ONLY);            
